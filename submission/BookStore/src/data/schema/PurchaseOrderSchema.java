...
//	'PROCESSED','SHIPPED','DENIED','DELIVERED','ORDERED'
	...
	public PurchaseOrderSchema() {
		...
		ATTRIBUTE_LABELS = new String[]{ID,ISBN,BOOK,AMOUNT,USER_TYPE,CREATED_AT_EPOCH,CREDIT_CARD,CREDIT_CARD_NUMBER,CREDIT_CARD_EXPIRY,CREDIT_CARD_CVV2,STATUS,STREET_NUMBER,STREET,POSTAL_CODE,CITY,PROVINCE,COUNTRY,EMAIL};
